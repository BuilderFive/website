...
import { FaArrowUp, FaCheck, FaRegFrown, FaRegSmile, FaRegSmileBeam, FaUser } from 'react-icons/fa';
import { FaFaceMeh, FaFaceSmile, FaRegFaceMeh, FaRegFaceSmile, FaX } from 'react-icons/fa6';
//create a scenario
export default function Problem() {
    return <div id="problem" className="relative px-[48px] max-md:px-[0px] w-full h-full">
        <div className='bg-background1 rounded-[24px] px-[24px] max-md:px-[12px] py-[48px] w-full h-full flex flex-col gap-[64px]'>
             <div className='flex flex-row flex-wrap max-md:flex-col lg:grid lg:grid-cols-2 max-lg:gap-[48px] gap-[96px]'>
                <div id="problem-row-1" className='flex justify-start items-start flex-col gap-[24px] w-full'>
                    ...
                    <div className='bg-background3 rounded-[24px] p-[24px] flex w-fit flex-row max-lg:flex-col gap-[24px] justify-center items-start max-md:items-center'>
                        ...
                        <div className='flex flex-col items-start justify-start max-w-[480px] w-full my-auto'>
                            <p className='text-text3 font-regular text-2xl'>• 21 yrs old, new graduate</p>
                            <p className='text-text3 font-regular text-2xl'>• Loves coding and chess</p>
                            <p className='text-text3 font-regular text-2xl'>• Building a startup</p>
                            <p className='text-text3 font-regular text-2xl'>• Moving to a new city soon</p>
                            <p className='text-orange-400 font-regular text-2xl'>• Worried, but it&#39;ll be okay</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="problem-row-2" className='flex justify-end items-end flex-col gap-[24px] w-full'>
                    ...
                    <div className='bg-background3 rounded-[24px] p-[24px] flex w-fit flex-row max-lg:flex-col gap-[24px] justify-center items-start max-md:items-center'>
                        ...
                        <div className='flex flex-col items-start justify-start max-w-[480px] w-full my-auto'>
                            <p className='text-orange-400 font-regular text-2xl'>• Finding the city scary</p>
                            <p className='text-orange-400 font-regular text-2xl'>• Trying to find friends</p>
                            <p className='text-orange-400 font-regular text-2xl'>• Working all the time</p>
                            <p className='text-text3 font-regular text-2xl'>• Things will be okay</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="problem-row-3" className='flex justify-start items-start flex-col gap-[24px] w-full'>
                    ...
                    <div className='bg-background3 rounded-[24px] p-[24px] flex w-fit flex-row max-lg:flex-col gap-[24px] justify-center items-start max-md:items-center'>
                        ...
                        <div className='flex flex-col items-start justify-start max-w-[480px] w-fit my-auto'>
                            <p className='text-red-500 font-regular text-2xl'>• Still can&#39;t make friends IRL</p>
                            <p className='text-red-500 font-regular text-2xl'>• Meeting too many weirdos at meetup events</p>
                            <p className='text-red-500 font-regular text-2xl'>• Not enough time to go out</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="problem-row-4" className='flex justify-end items-end flex-col gap-[24px] w-full'>
                    ...
                    <div className='bg-background3 rounded-[24px] p-[24px] flex w-fit flex-row max-lg:flex-col gap-[24px] justify-center items-start max-md:items-center'>
                        ...
                        <div className='flex flex-col items-start justify-start max-w-[480px] w-fit my-auto'>
                            <p className='text-text3 font-regular text-2xl italic'>&quot;I want to actually meet someone who&#39;s my age and is building a startup too, and who I don&#39;t have to spend HOURS trying to find&quot; <br/>- Marco</p>
                        </div>
                    </div>
                </div>
            </div>

            <div className='bg-background3 p-[24px] rounded-[24px] gap-[24px]'>
                ...
                <div className='flex flex-row justify-between max-lg:flex-col gap-[24px]'>
                    <div className='p-[24px] gap-[24px] flex flex-col justify-center items-center bg-background2 rounded-[12px] w-full'>
                        <img src="/static/meetup.svg" alt="BuilderFive" className="aspect-square h-[128px] rounded-full" />
                    ...
                    <div className='p-[24px] gap-[24px] flex flex-col justify-center items-center bg-background2 rounded-[12px] w-full'>
                        <img src="/static/discord.svg" alt="BuilderFive" className="aspect-square h-[128px] rounded-full" />
                        <div className='flex flex-col justify-start items-start w-full'>
                    ...
                    <div className='p-[24px] gap-[24px] flex flex-col justify-center items-center bg-background2 rounded-[12px] w-full'>
                        <img src="/static/clubhouse.svg" alt="BuilderFive" className="aspect-square h-[128px] rounded-full" />
                        <div className='flex flex-col justify-start items-start w-full'>
                            ...
                            <div className='flex flex-row gap-[12px] items-center justify-start'>
                                <FaX className='text-red-500 h-[24px] w-[24px]'/> 
                                <p className='text-red-500 text-xl font-medium'>Awkward to ask for meetups</p>
                            </div>
                        </div>                
                    </div>
                </div>
