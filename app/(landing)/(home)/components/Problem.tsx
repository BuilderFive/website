...
import { FaArrowUp, FaCheck, FaCircle, FaLine, FaRegFrown, FaRegSmile, FaRegSmileBeam, FaUser } from 'react-icons/fa';
        ...
        <div className='bg-background1 rounded-[24px] px-[24px] max-md:px-[12px] py-[48px] w-full h-full flex flex-col gap-[128px]'>
            ...
            <div id="builderfive" className='w-full h-full flex justify-center relative'>
                <div className='absolute p-[4px] w-fit rounded-full bg-gradient-to-r from-[var(--secondary-4)] to-[var(--secondary-1)] bg-[length:200%_200%] animate-gradient-x'>
                    ...
                    <p className='text-text1 text-5xl font-bold absolute bottom-4 w-full text-center'>BuilderFive</p>
                </div>
                <div className='w-full pt-[152px] min-h-[540px] border-secondary1 border-[4px] bg-background3 p-[24px] rounded-[24px] mt-[128px] flex flex-row max-lg:flex-col gap-[24px]'>
                    <div className='flex flex-col justify-start items-start w-full'>
                        <div className='flex flex-row gap-[12px] items-center justify-start'>
                            <FaCheck className='text-secondary1 h-[24px] w-[24px]'/> 
                            <p className='text-secondary1 text-xl font-medium w-full'>Meet new friends IRL, not strangers</p>
                        </div>
                        <div className='flex flex-row gap-[12px] items-center justify-start'>
                            <FaCheck className='text-secondary1 h-[24px] w-[24px]'/> 
                            <p className='text-secondary1 text-xl font-medium w-full'>Voice calls feel more real than text</p>
                        </div>
                        <div className='flex flex-row gap-[12px] items-center justify-start'>
                            <FaCheck className='text-secondary1 h-[24px] w-[24px]'/> 
                            <p className='text-secondary1 text-xl font-medium w-full'>Can create a chat for any topic</p>
                        </div>
                        <div className='flex flex-row gap-[12px] items-center justify-start'>
                            <IoMdRadioButtonOn className='text-text3 h-[24px] w-[24px]'/> 
                            <p className='text-text3 text-xl font-medium w-full'>Exclusive access for 2hrs once a week</p>
                        </div>
                        <div className='flex flex-row gap-[12px] items-center justify-start'>
                            <IoMdRadioButtonOn className='text-text3 h-[24px] w-[24px]'/> 
                            <p className='text-text3 text-xl font-medium w-full'>Talk genuinely w/ small group of five</p>
                        </div>
