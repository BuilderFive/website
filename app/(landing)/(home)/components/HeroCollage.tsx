export default function HeroCollage() {
    ...
    return (
        <div className="flex flex-col">
            <div id="collage-title" className="flex flex-col gap-[12px] justify-center items-center w-full">
                <p className="text-white text-2xl font-bold">You're a step away from finding your people</p>
            </div>
            <div className="flex flex-row flex-wrap justify-center gap-[24px]"> 
                ...
                <div className="h-[256px] text-transparent relative">
                    ...
                    <div className="absolute flex bottom-0 right-0 w-full h-full text-center justify-center hover:text-black items-center hover:backdrop-blur-md hover:text-2xl">
                        <p className="text-parent font-semibold">&quot;When I&#39;m at home I&#39;m a lot less productive. I wouldn&#39;t get as much done as I did in the last 2 hours&quot; - Alex</p>
                    </div>
                </div>
            </div>
        </div>
